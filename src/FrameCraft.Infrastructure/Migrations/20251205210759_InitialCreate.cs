        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageQuotaMB = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostPerMeter = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ProfitMargin = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Frames_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasGlass = table.Column<bool>(type: "bit", nullable: false),
                    HasPassepartout = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    LineFinalAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleLines_Frames_FrameId",
                        column: x => x.FrameId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 12, 5, 21, 7, 58, 962, DateTimeKind.Utc).AddTicks(3607), null, "Yönetici - Tüm yetkilere sahip", false, "Admin", null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2025, 12, 5, 21, 7, 58, 962, DateTimeKind.Utc).AddTicks(3835), null, "Standart Kullanıcı - Temel yetkiler", false, "User", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Frames_CompanyId",
                table: "Frames",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Frames_TenantId",
                table: "Frames",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_Frames_TenantId_CompanyId_Code",
                table: "Frames",
